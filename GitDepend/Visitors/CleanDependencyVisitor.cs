...
namespace GitDepend.Visitors
{
    ...
    public class CleanDependencyVisitor : NamedDependenciesVisitor
    {
        ...
        /// </summary>
        /// <param name="gitArguments">The list of arguments to provide to git clean</param>
        /// <param name="whitelist">The dependency name to clean.</param>
        public CleanDependencyVisitor(IList<string> gitArguments, IList<string> whitelist) : base(whitelist)
        {
